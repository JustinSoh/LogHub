...
export class AnalyticsService {
  ...
  private detailsStatus = new BehaviorSubject<Boolean>(null);
  public currentDetails = this.detailsStatus.asObservable();
  
  //To set currentDataset
  private bwHost = new BehaviorSubject<String>(null);
  public currentHost = this.bwHost.asObservable();
  ...
  HostStatus(value:String)
  {
    this.bwHost.next(value);
  }
